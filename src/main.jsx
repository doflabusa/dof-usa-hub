  ...
  return (
    <div className="app">
      ...
      <main>
        ...
        {page==='Dashboard' &&
          <Dashboard quote={dashboardQuote} open={open} tasks={activeTasks} events={events} leaves={visibleLeaves} startShift={startShift} endShift={endShift} setPage={setPage} month={month} setMonth={setMonth} />
        }
